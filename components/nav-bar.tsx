...
export function NavigationBar() {
    return (
        <>
            <NavigationMenu className="hidden sm:flex sm:sticky sm:top-0 min-w-full backdrop-blur-lg container justify-between ">
                <Link href="/" passHref>
                    <Avatar className="cursor-pointer">
                        <AvatarImage src={me.src} alt="@Carl" />
            ...
            <Sheet>
                <SheetTrigger className="sm:hidden sticky top-0 container py-2 justify-end flex z-10">
                    <Menu />
                </SheetTrigger>
